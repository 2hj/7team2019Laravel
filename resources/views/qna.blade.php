                ...
                <form id="bookForm" name="bookForm" class="form-horizontal">
                   ...
                   <input type="hidden" name="user_id" id="user_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea id="content" name="content" required="" placeholder="Enter content" class="fcontent-control"></textarea>
                        </div>
                    </div>
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.editBook', function () {
      var id = $(this).data('id');
      $.get("{{ route('qna.index') }}" +'/' + id +'/edit', function (data) {
